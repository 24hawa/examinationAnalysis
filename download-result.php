...
<p><b>Student Matric No. :</b> <?php echo htmlentities($result->RollId);?>
<p><b>Student Course:</b> <?php echo htmlentities($result->ClassName);?>(<?php echo htmlentities($result->Section);?>)
<?php }
